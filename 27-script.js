...
console.log(
  "=========== querySelectorAll() with element class =============== "
);
...
console.log(
  "=========== querySelectorAll() with element name =============== "
);
...
const paraTextNode = document.createTextNode(
  "My Hobbies: Reading, Writing and Time pass"
);
