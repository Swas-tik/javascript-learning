...
class Person {
  ...
  details() {
    console.log(
      `==== Base class details() ===> Students ${this.fullName} Details ====== `
    );
  }
}
...
class Student extends Person {
  ...
  studentDetails() {
    console.log(
      `Student Details: ${this.fullName}, ${this.city}, ${this.age}, ${this.profession}`
    );
  }
  ...
  details() {
    ...
    console.log(
      `Hello My details are: ${this.fullName}, ${this.city}, ${this.age}, ${this.profession} `
    );
  }
}
